...
public class Board extends JPanel {
    ...
    // Handle drawing of game elements
    ...
    private void gameOver(Graphics g) {
        ...
        g.setColor(Color.white);
        g.setFont(small);
        g.drawString(message, (Params.BOARD_WIDTH - fontMetrics.stringWidth(message)) / 2, Params.BOARD_WIDTH / 2);
    }
        ...
        if (shot.isVisible()) {
            ...
            for (Alien alien : aliens) {
                ...
                if (alien.isVisible() && shot.isVisible()) {
                    if (shotX >= (alienX) && shotX <= (alienX + Params.ALIEN_WIDTH) && shotY >= (alienY) && shotY <= (alienY + Params.ALIEN_HEIGHT)) {
    ...
    // Game cycle to update and repaint the game
    private void doGameCycle() {
        update();
        repaint();
    }

    // ActionListener for the game cycle
